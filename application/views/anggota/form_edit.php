                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-body" id="EditAnggota">
                                    ...
                                    <?php 
                                        foreach ($anggota as $p){
                                            echo "<option value='$p->nrp'";
                                            echo $record ['nrp']==$p->nrp?'selected':'';
                                            echo ">$p->jk</option>";
                                        }
                                    ?>
                                    ...
                                    <button type="submit" name="submit" value="Submit" id="submit" class="btn btn-primary btn-sm mt-3">Edit</button>   
