        ...
        <tr>
            <td>
                <span style="font-size: 12px; font-weight:; line-height: 1.5;">Di tetapkan di &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : <?php echo $record['diterapkan']; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <p><br></p>
                        <u><span style="line-height: 1.5; font-size: 12px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $record['d_oleh']; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u></span>
                        <br><span style="font-size: 12px; margin-left: 25%;"><?php echo $record['sebagai']; ?> NRP <?php echo $record['nrp_p']; ?></span>
                </span>
            </td>
        </tr>
    </table>
