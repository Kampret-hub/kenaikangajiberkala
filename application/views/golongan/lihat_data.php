                            ...
                            <tr class="">
                                ...
                                <td><button class="btn btn-sm dropdown-toggle more-horizontal" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                  ...
                                  <div class="dropdown-menu dropdown-menu-right">
                                    <a href=" <?php echo base_url('golongan/edit/'.$r->id_golongan) ?>" class="btn btn-primary btn-small" style='margin-left: 5px;'><i class="fas fa-edit"></i>Edit</a>
                                    <a href="<?php echo base_url('golongan/delete/'.$r->id_golongan)?>" class="btn btn-danger btn-small hapus" id="hapus" ><i class="fas fa-trash"></i>Hapus</a>
                                  </div>
                                </td>
                            </tr>
                        <?php $no++; } ?>
