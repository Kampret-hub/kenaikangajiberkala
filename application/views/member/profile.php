        ...
        <div class="d-flex flex-column align-items-center text-center">
          ...
          <div class="mt-3">
            <h4 style="text-transform: uppercase;"><?php echo substr($member['nama_lengkap'],0,25); ?></h4>
              ...
              <hr>
              <a href=" <?php echo base_url('member/profile/edit') ?>" class="btn btn-primary btn-small" style='margin-left: 5px;'><i class="fe fe-edit"></i> Edit Profile</a>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="card-body">        
        <table class="table-striped table-bordered table-hover nowrap" id="dataTable-1" style="width: 100%;">
            ...
            <tr>
              ...
              <td>
                <a href="<?php echo base_url('member/profile/lihat_cetak/'.$r->id)?>" class="btn btn-info btn-small" id="" ><i class="fe fe-eye"></i> Lihat</a>
              </td>
            </tr>
            <?php $no++; } ?>
        </table>
