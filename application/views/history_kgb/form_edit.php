                ...
                <div class="col-md-6">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                         <select type="option" class="form-control"  name="periode_thn">
                                            <option type="option" class="form-control"  name="periode_thn" value="<?php echo $record['periode_thn']?>"><?php echo $record['periode_thn']?></option>
                                            <hr>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <select type="option" class="form-control"  name="periode_bln">
                                            <option type="option" class="form-control"  name="periode_bln" value="<?php echo $record['periode_bln']?>"><?php echo $record['periode_bln']?></option>
                                            <hr>
